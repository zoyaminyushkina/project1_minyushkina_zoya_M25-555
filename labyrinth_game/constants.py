...
ROOMS = {
    ...
    "my_room_1": {
        ...
        "puzzle": (
            'На стене надпись: "Cекрет зелья станет открытым, сложите числа 3 и 7". Введите ответ цифрой.',
            "10",
        ),
    },
    "my_room_2": {
        ...
        "puzzle": (
            'Чтобы идти, решите загадку: "Сколько ног у трёх кошек?" Введите число.',
            "12",
        ),
    },
}
