...
set -gx VIRTUAL_ENV 'C:\Users\alexa\PycharmProjects\project1_minyushkina_zoya_M25-555\.venv'
...
if test -n project1-minyushkina-zoya-m25-555-py3.12
    set -gx VIRTUAL_ENV_PROMPT project1-minyushkina-zoya-m25-555-py3.12
else
